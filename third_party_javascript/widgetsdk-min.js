new function () {
  ...
  this._init = function () {
    if (!b) {
      ...
      d.OnLoad(function () {
        d.getContext().Event.Trigger("GET_INIT_PARAMS", !0, !0).then(function (b) {
          c.initParams = b;
          d.getContext().Event.Trigger("GET_QUERY_PARAMS", !0, !0).then(function (h) {
            c.queryParams = h;
            a();
          });
        });
      ...
      init: function () {
        if (!b) {
          ...
          d.OnLoad(function () {
            d.getContext().Event.Trigger("GET_INIT_PARAMS", !0, !0).then(function (b) {
              c.initParams = b;
              d.getContext().Event.Trigger("GET_QUERY_PARAMS", !0, !0).then(function (b) {
                c.queryParams = b;
                a();
              });
            });
...
export function Records(b) {
  ...
  function e(a, b) {
    ...
    for (c in a) {
      ...
      if (k = !(b && b.includes(c))) {
        ...
        var d = !1,
            g;
        if (!(g = !k || null == k || "" === k || "string" == typeof k && 0 == k.trim().length) && (g = "object" == typeof k)) a: {
          g = void 0;
  ...
  return {
    addRecord: function (a) {
      if (e(a)) return new Promise(function (a, b) {
        b("Improper Configuration..!!");
      });
      d(a);
      a = {
        formLinkName: a.formName,
        body: a.data
      };
    ...
    getAllRecords: function (a) {
      if (e(a, ["criteria", "page", "pageSize"])) return new Promise(function (a, b) {
        b("Improper Configuration..!!");
      });
      d(a);
      a = {
    ...
    uploadFile: function (a) {
      if (e(a, ["file", "parentId"])) return new Promise(function (a, b) {
        b("Improper Configuration..!!");
      });
      d(a);
      return a.file ? a.file.size && 50 < a.file.size / 1024 / 1024 ? new Promise(function (a, b) {
        b("Improper Configuration..!!");
        ...
        d.then(function (c) {
          ...
          b.appSDK.getContext().Event.Trigger("UPLOAD_FILE", c, !0).then(function (a) {
            k(a);
          }).catch(function (a) {
            h(a);
          });
...
export function Util(b) {
  return {
    setImageData: function (d, e, c) {
      if (e.startsWith("/api/v2/")) {
        var a = {};
        a.src = e;
        b.appSDK.getContext().Event.Trigger("IMAGE_LOAD", a, !0).then(function (a) {
...
export function ZSDKUtil(b) {
  function d(a) {}

  function e(a) {
    var b = {};
    return a = a || window.location.href, a.substr(a.indexOf("?") + 1).split("\x26").forEach(function (a, c) {
      a = a.split("\x3d");
      b[a[0]] = a[1];
    }), b.hasOwnProperty("serviceOrigin") && (b.serviceOrigin = decodeURIComponent(b.serviceOrigin)), b;
  }

  var c,
      a = e();
  return d.prototype.Info = function () {
  ...
  }, b.GetQueryParams = e, b.isDevMode = function () {
...
window.ZSDKUtil || {}, ZSDKMessageManager = function (b) {
  ...
  var d = ZSDKUtil.getLogger(),
      e = {};
  return b.AttachEventListener = function (b, a) {
    "function" == typeof a && (Array.isArray(e[b]) || (e[b] = []), e[b].push(a));
  }, b.NotifyEventListeners = function (b, a, k) {
    var c = a.match(/^__[A-Za-z_]+__$/gi);
    if ((c = (Array.isArray(c) && c.length, e[a])) && Array.isArray(c)) for (a = 0; a < c.length; a++) c[a].call(b, k);else d.Info("Cannot find EventListeners for Event : ", a);
